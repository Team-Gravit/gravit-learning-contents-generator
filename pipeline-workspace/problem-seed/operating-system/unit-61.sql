...
VALUES (3543, 1244, '프로세스와 스레드는 자원을 동일하게 사용한다', '프로세스는 독립적이고 스레드는 공유한다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3563, 1251, '단일 스레드에서만 발생한다', '멀티스레드 환경에서 발생한다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3583, 1258, '스레드 생성/제거 오버헤드 증가', '오히려 감소한다.', false),
