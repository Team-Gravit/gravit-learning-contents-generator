...
VALUES (1202, 173, '아래 제시한 개념에 대한 설명으로 옳은 것은?', '인터럽트는 CPU의 효율적인 동작을 위한 메커니즘이다.', 'OBJECTIVE'),
       ...
       (1204, 173, '제시된 내용과 관련하여 옳지 않은 것은?', '인터럽트는 여러 목적으로 사용된다.', 'OBJECTIVE'),
...
VALUES (3423, 1202, '인터럽트는 CPU가 계속 대기하도록 만든다', '인터럽트는 CPU 유휴 시간을 최소화한다.', false),
...
VALUES (1209, 174, '아래 제시한 개념에 대한 설명으로 옳은 것은?', '하드웨어 인터럽트는 외부 장치에 의해 발생한다.', 'OBJECTIVE'),
       ...
       (1211, 174, '제시된 내용과 관련하여 옳지 않은 것은?', '소프트웨어 인터럽트는 프로그램 실행 중 발생한다.', 'OBJECTIVE'),
       ...
       (1215, 174, '아래 제시한 개념에 대한 설명으로 옳지 않은 것은?', '타이머 인터럽트는 운영체제에서 중요한 역할을 한다.', 'OBJECTIVE');

INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3443, 1209, 'I/O 작업 완료, 키보드 입력', '하드웨어 인터럽트는 외부 하드웨어 장치가 CPU에 신호를 보내 발생한다. I/O 완료, 타이머, 전원 장애, 하드웨어 오류 등이 있다.', true),
...
VALUES (1216, 175, '아래 제시한 개념에 대한 설명으로 옳은 것은?', '인터럽트는 우선순위에 따라 처리된다.', 'OBJECTIVE'),
       ...
       (1218, 175, '제시된 내용과 관련하여 옳지 않은 것은?', '인터럽트 우선순위 처리에는 여러 방법이 있다.', 'OBJECTIVE'),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3463, 1216, '외부 신호 인터럽트', '우선순위가 가장 낮다.', false),
