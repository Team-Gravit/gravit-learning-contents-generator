...
VALUES (3767, 1325, '스택 영역은 낮은 주소에서 높은 주소 방향으로 증가한다.', '스택 영역은 높은 주소에서 낮은 주소 방향으로 증가한다. 낮은 주소에서 높은 주소 방향으로 증가하는 것은 힙 영역이다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3783, 1331, '컴파일 타임 바인딩은 컴파일 시 물리 주소가 결정된다.', '컴파일 타임 바인딩은 컴파일 시 물리 주소가 결정되며, 물리 주소를 변경하려면 다시 컴파일해야 한다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3803, 1339, '세그먼테이션을 사용하여 프로그램을 논리적 단위로 분할한다', '세그먼테이션은 내부 단편화를 해결하는 방법이다. 외부 단편화는 여전히 발생할 수 있다.', false),
