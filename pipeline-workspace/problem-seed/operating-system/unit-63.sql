...
VALUES (3663, 1286, '단일 프로세스에서만 필요하다', '여러 프로세스나 스레드가 있을 때 필요하다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3683, 1293, '하드웨어 명령어만 사용한다', '소프트웨어 도구이다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3703, 1300, '무한 버퍼를 사용한다', '한정 버퍼를 사용한다.', false),
