...
VALUES (3847, 1363, '가장 먼저 들어온 페이지를 교체한다', '가장 먼저 들어온 페이지를 교체하는 것은 FIFO 알고리즘이다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3855, 1367, '전역 교체는 모든 프로세스의 페이지 중에서 교체 대상을 선택한다', '전역 교체는 모든 프로세스의 페이지를 대상으로 교체할 페이지를 선택한다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3863, 1373, '2단계 페이지 테이블에서 1단계는 페이지 디렉토리로 2단계 페이지 테이블 주소를 저장한다', '2단계 페이지 테이블에서 1단계(페이지 디렉토리)는 2단계 페이지 테이블의 주소를 저장한다.', false),
