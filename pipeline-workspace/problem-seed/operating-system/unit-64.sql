...
VALUES (3723, 1309, '자원 공유', '데드락 발생 조건이 아니다.', true),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3731, 1313, '필요한 모든 자원을 한꺼번에 요청하여 점유 대기를 방지한다', '점유 대기 조건을 제거하는 데드락 예방 방법이다.', true),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3747, 1319, '안전 순서가 존재하면 안전 상태이다', '안전 순서가 존재할 때 안전 상태로 판단한다.', true),
