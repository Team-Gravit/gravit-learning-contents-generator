...
VALUES (3603, 1265, 'CPU 스케줄링은 하드웨어가 자동으로 수행한다', '운영체제가 수행한다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3623, 1272, '평균 대기 시간이 최대이다', '평균 대기 시간이 이론적으로 최소이다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3643, 1279, '프로세스가 큐 간 자유롭게 이동할 수 있다', 'MLQ는 큐 간 이동이 불가능하다.', false),
