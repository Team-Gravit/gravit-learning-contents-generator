...
VALUES (3363, 1181, '시스템 콜은 응용 프로그램 내부의 함수 호출이다', '시스템 콜은 운영체제 커널을 호출하는 것이다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3383, 1188, '항상 0을 반환한다', 'fork()는 부모와 자식에서 다른 값을 반환한다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3403, 1195, '둘 다 모드 전환이 발생한다', '함수 호출은 모드 전환이 없다.', false),
