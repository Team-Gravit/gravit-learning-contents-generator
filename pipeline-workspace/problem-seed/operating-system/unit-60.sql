...
VALUES (3483, 1223, 'fork()만으로 새로운 프로그램을 실행할 수 있다', 'fork()는 현재 프로세스를 복제할 뿐이다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3503, 1230, '프로세스는 기본적으로 메모리를 공유하므로 IPC가 불필요하다', '프로세스는 독립된 메모리 공간을 가진다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3523, 1237, '구현이 복잡하다', 'FCFS는 구현이 간단하다.', false),
