...
VALUES (2943, 1034, '페이징은 모든 데이터를 한 번에 조회하는 방법이다', '페이징은 데이터를 나누어 조회한다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (2963, 1041, '첫 번째 페이지를 조회한다', 'OFFSET 20이므로 첫 20개를 건너뛴다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (2983, 1048, 'OFFSET이 클수록 성능이 저하된다', 'OFFSET이 커질수록 데이터베이스는 건너뛸 행까지 모두 읽어야 하므로 성능이 저하된다. 마지막 페이지로 갈수록 느려진다.', true),
