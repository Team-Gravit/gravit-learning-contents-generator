...
VALUES (3003, 1055, '뷰는 실제 데이터를 물리적으로 저장한다', '뷰는 데이터를 저장하지 않고 쿼리 결과만 보여준다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3023, 1062, '모든 학생을 조회하는 뷰를 생성한다', 'WHERE 조건으로 필터링한다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3043, 1069, '단일 테이블을 기반으로 한 뷰', '조건을 만족하면 단일 테이블 뷰도 수정 가능하다.', false),
