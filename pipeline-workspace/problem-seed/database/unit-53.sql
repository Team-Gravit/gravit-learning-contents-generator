...
VALUES (3063, 1076, '정규화는 데이터 중복을 증가시킨다', '정규화는 데이터 중복을 제거한다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3083, 1083, '모든 속성이 기본키에 완전 함수 종속되어야 한다', '제2정규형의 조건이다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3103, 1090, '1NF → 2NF → 3NF → BCNF', '정규화는 제1정규형부터 시작하여 제2정규형, 제3정규형, BCNF 순으로 진행된다. 각 단계는 이전 단계를 만족해야 한다.', true),
