...
VALUES (2583, 908, '유일성은 하나의 키 값으로 하나의 튜플만 식별할 수 있는 성질이다', '유일성(Uniqueness)은 하나의 키 값으로 하나의 튜플만 식별할 수 있는 성질이다. 동일한 키 값을 가진 튜플이 두 개 이상 존재하면 유일성을 만족하지 않는다.', true),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (2603, 915, 'NULL 값을 가질 수 있다', '기본키는 NOT NULL 제약이 적용되어 NULL 값을 가질 수 없다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (2623, 922, '{학번}', '학번만으로는 한 학생이 여러 과목을 수강하는 경우를 구분할 수 없다.', false),
