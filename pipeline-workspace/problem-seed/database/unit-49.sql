...
-- Unit: 서브쿼리 (Unit ID: 49)

-- Lesson 생성
INSERT INTO lesson (id, unit_id, title)
VALUES (143, 49, '서브쿼리 기초'),
       (144, 49, '서브쿼리 심화'),
       (145, 49, '서브쿼리 활용');
...
VALUES (2823, 992, '서브쿼리는 항상 WHERE 절에만 사용할 수 있다', '서브쿼리는 SELECT, FROM, WHERE, HAVING 등 다양한 절에 사용할 수 있다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (2843, 999, 'IN', 'IN은 다중 행 서브쿼리에서 사용하는 연산자이다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (2863, 1006, '각 학생의 이름과 평균 급여를 조회한다', 'SELECT 절의 스칼라 서브쿼리로 전체 학생의 평균 급여를 계산하여 모든 행에 동일한 평균값을 표시한다.', true),
