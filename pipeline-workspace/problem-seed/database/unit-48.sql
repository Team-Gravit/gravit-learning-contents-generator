...
-- Unit: DML(Data Manipulation Language) (Unit ID: 48)
...
VALUES (2763, 971, '데이터베이스의 구조를 정의하는 언어이다', '이것은 DDL(Data Definition Language)의 설명이다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (2783, 978, 'student_id가 1인 학생의 이메일을 수정한다', 'UPDATE ... SET ... WHERE는 조건에 맞는 행의 특정 컬럼 값을 수정한다.', true),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (2803, 985, 'students 테이블의 특정 컬럼만 조회한다', '*는 모든 컬럼을 의미한다.', false),
