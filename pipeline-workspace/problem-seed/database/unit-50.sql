...
VALUES (2883, 1013, '조인은 하나의 테이블 내에서만 데이터를 조회한다', '조인은 두 개 이상의 테이블을 연결한다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (2903, 1020, '왼쪽 테이블의 모든 행을 포함한다', 'LEFT JOIN의 특징이다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (2923, 1027, '모든 학생과 학과를 조회한다', 'WHERE 조건으로 필터링한다.', false),
