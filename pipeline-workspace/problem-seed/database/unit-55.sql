...
VALUES (3183, 1118, '인덱스는 데이터를 물리적으로 저장한다', '인덱스는 데이터의 위치 정보를 저장한다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3203, 1125, '테이블당 여러 개 생성할 수 있다', '클러스터형 인덱스는 테이블당 하나만 생성 가능하다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3223, 1132, 'WHERE name = ''홍길동''', '인덱스가 있으면 사용된다.', false),
