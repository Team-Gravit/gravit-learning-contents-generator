...
-- Unit: 트랜잭션 (Unit ID: 54)

-- Lesson 생성
INSERT INTO lesson (id, unit_id, title)
VALUES (158, 54, '트랜잭션 기초'),
       (159, 54, '트랜잭션 제어'),
       (160, 54, '격리 수준과 동시성');
...
VALUES (3123, 1097, '트랜잭션은 데이터를 조회만 하는 단위이다', '트랜잭션은 조회뿐만 아니라 삽입, 수정, 삭제를 포함한다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3143, 1104, '트랜잭션을 확정한다', 'COMMIT이 트랜잭션을 확정한다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (3163, 1111, '트랜잭션이 모두 성공하거나 모두 실패해야 한다', '원자성의 의미이다.', false),
