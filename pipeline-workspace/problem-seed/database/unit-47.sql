...
-- Unit: DDL(Data Definition Language) (Unit ID: 47)
...
VALUES (2703, 950, '데이터를 조회하고 조작하는 언어이다', '이것은 DML(Data Manipulation Language)의 설명이다.', false),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (2723, 957, 'students 테이블에 phone 컬럼을 추가한다', 'ALTER TABLE ... ADD는 테이블에 새로운 컬럼을 추가하는 명령이다. VARCHAR(20) 타입의 phone 컬럼이 추가된다.', true),
...
INSERT INTO option (id, problem_id, content, explanation, is_answer)
VALUES (2743, 964, 'students 테이블을 무조건 삭제한다', 'IF EXISTS가 없으면 테이블이 없을 때 오류가 발생한다.', false),
